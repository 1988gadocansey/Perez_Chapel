...
if (isset($_POST[submit])) {
    ...
    if ($numRow > 0) {
        header("location:process_general_payments.php?member=$member");
    } else {
        header("location:make_general_payment.php?error=1");
    }
}
?>
                            ...
                            <div class="panel panel-lined panel-hovered mb20 table-responsive basic-table">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div>
                                        ...
                                        <form action="make_general_payment.php?submit=1" method="post"class="person-form form-horizontal form-horizontal-custom" autocomplete="off" role="form">
                                            <p>&nbsp;</p>
