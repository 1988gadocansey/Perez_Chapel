		...
		<div class="content-container" id="content">
			...
			<div class="page page-ui-tables">
				 <ol class="breadcrumb breadcrumb-small">
					...
					<li class="active"><a href="#">Church Members</a></li>
				</ol>
                            <div class="page-wrap">
                                <div class="note note-success note-bordered">
						<?php  if($_SESSION['level']=='Assistant Pastor' || $_SESSION['level']=='Church Admin' || $_SESSION['level']=='Elder' || $_SESSION['level']=='Head Pastor'){?>
                                                ...
                                                <div class="table-responsive">
                                                    <?php
                                                           ...
                                                           if($department=="All departments" or $department=="" ){ $department=""; }else {$department_=" and DEPARTMENT = '$department' "  ;}
                                                            ...
                                                            $query="SELECT  * FROM  perez_members  where 1 $branch_  $ministry_  $search_ $gender_ $ethnic_ $status_ $team_ $category_ $demo_ $department_ $language_" ;
