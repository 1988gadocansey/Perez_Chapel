        ...
        <div class="content-container" id="content">
			...
			<div class="page page-ui-tables">
				<ol class="breadcrumb breadcrumb-small">
					...
					<li class="active"><a href="#">Districts</a></li>
				</ol>
                             ...
                             <div><?php $notify->Message(); ?></div>
                               ...
                               <form action="" method="post" class="form-horizontal row-border"   id="form">
                                         ...
                                         <tr>
                                           ...
                                           <td>
                                               <select style="width:230px" name='region' onchange="document.location.href='<?php echo $_SERVER['PHP_SELF'] ?>?region='+escape(this.value);"  >
                                                            <option value=''>select region Region </option>
                                                            <option value="all departments">All region department</option>
                                                                <?php
                                                            ...
                                                            while ($row = $rowa->FetchRow()) {
                                                                extract($row);
                                                                ?>
                                                            <option <?php if($_SESSION['region']==$PARENT){echo "selected='selected'";} ?>  value="<?php echo $NAME; ?>"><?php echo $NAME; ?></option>
...
$query ="SELECT * FROM `perez_districts` WHERE 1 $dept_  $search_ ORDER BY NAME ASC";
                   //print_r($query);
                    ...
                    while($rt=$rs->FetchRow()){
                       ...
                       ?>
                                    ...
                                    <td><?php  echo $count; ?></td>
                                     ...
                                     <td style="text-align:"><?php echo $rt[REGION] ?></td>
