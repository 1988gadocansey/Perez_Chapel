...
class Datatables {
    ...
    public function query($query)
    {
        ...
        $this->data = $this->db->query($sql . $search .  $this->limit());
    ...
    public function addButtonActions($id) {
        $string = "<a href=' view_leave_setup.edit ' class='btn btn-success btn-xs'>Edit</a>&nbsp;";
    ...
    private function response($data)
    {
        ...
        $response['data'] = $data;
        $response['data'] = $this->addButtonActions($this->columns[0]);
