                                        ...
                                        <form action="" method="post" class="form-horizontal row-border"   id="form" novalidate="" name="applicationForm"  v-form>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <p  class=" text-danger text-small  "   v-if="applicationForm.service.$error.required">Service Name to generate attendance report required</p>  
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 col-sm-offset-3">
                                                        <div class="btn-toolbar">
                                                            <button type="submit" name="submit"class="btn-primary btn btn-success" onclick="return MM_openBrWindow('reportAttendanceList?service=<?php echo $_POST['service'] ?>','','menubar=yes,width=700,height=450')"  v-show="applicationForm.$valid" >Save</button>
