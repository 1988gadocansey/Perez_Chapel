<?php
        ...
        if(isset($_GET[delete])){
            $query=$sql->Prepare("UPDATE `perez_member_payments` SET payment_status='disabled' WHERE id='$_GET[delete]'");
            if($sql->Execute($query)){
                header("location:viewMembersPayment?success=1");
            }
        }
        ...
        <div class="content-container" id="content">
			...
			<div class="page page-ui-tables">
				<ol class="breadcrumb breadcrumb-small">
					...
					<li class="active"><a href="#">Individual Payments Reports</a></li>
				</ol>
                                     ...
                                     <div class="col-md-12" style="width:1200px;margin-left: -95px">
                                        <div class="panel panel-lined panel-hovered mb20 table-responsive basic-table">
                                            <div class="panel-heading panel-info">
                                                <a href="member_payment.php"  style="margin-top: -17px;margin-left: -25px"  title="create a new group"  class="btn btn-pink waves-effect btn-sm">Make Member Payments<i class="fa fa-plus-circle"></i></a>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="20%">
                                                                    ...
                                                                    <select class='form-control select2_sample1'     style="margin-left:0%; width:190px " onchange="document.location.href='<?php echo $_SERVER['PHP_SELF'] ?>?type='+escape(this.value);" >
                                                                        ...
                                                                        $query2=$sql->Prepare("SELECT * FROM `perez_member_payment_type` WHERE  status='enabled' ");
                                                    ...
                                                    <?php
                                                            ...
                                                            $start=$_SESSION[start];
                                                             ...
                                                             if(!empty($start) && !empty($end)){
                                                                 $date_="AND date(date_time) BETWEEN '$start' AND '$end'";
                                                             }
                                                             elseif(!empty ($start)){
                                                                 $date_="AND date(date_time) = '$start'";
                                                                  $_SESSION[end]="";
                                                             }
                                                             elseif(!empty ($end)){
                                                                 $date_="AND date(date_time) <= '$end'";
                                                                  $_SESSION[start]="";
                                                             }
                                                            $search=$_POST[search];
                                                            

                                                            if($type=="All type" or $type==""){ $type=""; }else {$type_=" and  payment_type_name = '$type' "  ;}
                                                             
                                                            
                                                            
                                                            if($search=="" ){ $search=""; }else {$search_="AND giving_number = '$search' "  ;}

                                                            $query="SELECT * FROM `perez_member_payments` WHERE 1 AND payment_status='enabled' $type_     $search_  $date_   " ;
                                                          ...
                                                          $count=0;
                                                           ...
                                                           <tr>
                                                               ...
                                                               <td style="text-align:"><?php echo $member->GIVING_NUMBER ?></td>
                                                                ...
                                                                <td style="text-align:"><?php echo $help->getGeneralPaymentName($rtmt[payment_type_name]) ?></td>
                                                             ...
                                                             <td>  
                                                                 ...
                                                                 <a onclick="return confirm('Are you sure you want to disable this payment??')" href="viewMembersPayment?delete=<?php echo  $rtmt[id] ?>"><i class="fa fa-trash-o" title="click to delete"></i> </a>
                                                             </td>
